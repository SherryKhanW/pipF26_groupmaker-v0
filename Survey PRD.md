...
|---|---|---|---|---|
| name | What is your name? | dropdown | populated from `data/roster.json` | no |
| school_year | What year are you in? | dropdown | First-year / Sophomore / Junior / Senior / Other | no |
| major | What is your major? | dropdown | Finance / Marketing / Information Systems / Economics / Computer Science / Undeclared / Other | no |
| python_proficiency | What is your proficiency in Python? | 1–5 scale | 1 / 2 / 3 / 4 / 5 | no |
